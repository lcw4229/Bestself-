...
OUTPUT = "/home/user/Bestself-/demand_letter_Lopez_v_Abdelrahim_GEICO.pdf"
...
def re_block():
    ...
    data = [
        [Paragraph("Re:", RE_LABEL),
         ...
         Paragraph("Eusebia Abdelrahim", RE_LABEL)],
        ["",
         Paragraph("Our Client:", RE_LABEL),
         Paragraph(
             "Tavia Lemon, daughter to Elda Marisol Lopez (deceased)",
             RE_LABEL)],
        ["",
         Paragraph("Claim No.:", RE_LABEL),
         Paragraph("8796936100000002", RE_LABEL)],
        ["",
...
def build():
    doc = SimpleDocTemplate(
        ...
        title="Demand Letter – Lopez v. Abdelrahim/GEICO",
    ...
    # ── Addressee block ──
    story.append(Paragraph("<i><b>Via Facsimile: (214) 442-5164</b></i>", FAX_STYLE))
    story.append(Paragraph("GEICO Insurance", PLAIN_ADDR))
    story.append(Paragraph("<b>ATTN: Shannon Gutierrez</b>", BOLD_STYLE))
    story.append(Paragraph("P.O. Box 509105", PLAIN_ADDR))
    story.append(Paragraph("San Diego, CA 92150", PLAIN_ADDR))
    ...
    # ── Salutation ──
    story.append(Paragraph("Dear Ms. Gutierrez:", SALUTE))

    # ── Opening paragraph ──
    story.append(Paragraph(
        "I am writing this letter on behalf of Tavia Lemon, daughter to Elda Marisol Lopez, "
        "Deceased, for the catastrophic injuries and wrongful death her mother suffered as the "
        "result of a motor vehicle collision which occurred on June 20, 2025. We hereby send a "
        "demand for policy limits pursuant to the Stowers’ Doctrine, such offer remaining open "
        "until June 24, 2026.",
        NORMAL))

    # ── Facts of the collision ──
    story.append(Paragraph(
        "On June 20, 2025, your insured, Eusebia Abdelrahim, was operating a 2020 White Toyota "
        "Tundra traveling north on the 400 block of South Port Avenue in Corpus Christi, Nueces "
        "County, Texas. Your insured attempted to execute a left turn onto the 2800 block of "
        "Agnes Street and drove directly into the path of a 2020 Gray Honda Civic driven by "
        "Keith N. Alvarez, who was traveling south on the 100 block of North Port Avenue with a "
        "green light. The violent collision resulted in severe damage to both vehicles and the "
        "catastrophic injury of Elda Marisol Lopez, who was a passenger in the Alvarez vehicle. "
        "Officer Lenortavage, Badge No. 12204, of the Corpus Christi Police Department responded "
        "to the scene and completed a Texas Peace Officer’s Crash Report (Case No. C2503621). "
        "Please see the certified crash report attached hereto.",
        NORMAL))
    story.append(Paragraph(
    ...
    story.append(Paragraph(
        ...
        "mother of Tavia Lemon, who was present at her bedside during the final moments of her "
        "life. Ms. Lopez was a woman of deep family devotion, and her sudden and tragic death "
        "has left an irreparable void in the life of her daughter and all those who loved and "
        "depended upon her.",
        NORMAL))
    ...
    story.append(Paragraph(
        ...
        "Tavia Lemon, as the wrongful death beneficiary of Elda Marisol Lopez, has suffered and "
        "will continue to suffer the devastating loss of her mother’s love, companionship, "
        "comfort, guidance, and society. She witnessed her mother’s prolonged and painful "
        "decline, stood at her bedside as she died, and will carry that grief for the remainder "
        "of her life. The mental anguish endured by Ms. Lemon is profound and ongoing.",
        NORMAL))

    story.append(Paragraph(

        "It is reasonably foreseeable that Tavia Lemon will continue to endure significant "
        "emotional hardship and grief for the remainder of her life. Her non-economic damages "
        "are substantial and ongoing.",
        NORMAL))

    story.append(Paragraph(

        "Liability in this matter is clear. Your insured, Eusebia Abdelrahim, negligently "
        "executed a left turn directly into the path of oncoming traffic, causing a violent "
        "collision that inflicted life-ending internal injuries upon Elda Marisol Lopez, an "
        ...
        "and death — are severe, well-documented, and irrefutably connected to your "
        "insured’s negligent conduct. Should this matter proceed to litigation, a jury "
        "would likely return a verdict well in excess of policy limits, awarding damages for "
        "both economic and non-economic losses, including the survival damages of Ms. Lopez "
        "for her pre-death pain and suffering, as well as the wrongful death damages of "
        "Tavia Lemon for loss of companionship, grief, mental anguish, and the loss of the "
        "love and support of her mother.",
        NORMAL))
    ...
    story.append(Paragraph(
        ...
        "To be clear, the intent of this offer is to place GEICO Insurance in a Stowers "
        "situation as that term is commonly known within the insurance and litigation industry. "
        "Your insured should be made aware of the following:",
        NORMAL))

    stowers = [
        ("1.", "TEXAS RECOGNIZES A CAUSE OF ACTION ON THE PART OF AN INSURED AGAINST THE "
         "INSURED'S LIABILITY INSURANCE CARRIER (in this case GEICO Insurance) IF THE "
         "INSURED IS DAMAGED BECAUSE OF THE CARRIER'S NEGLIGENCE IN REFUSING TO SETTLE "
         "CLAIMS AGAINST THE INSURED WITHIN POLICY LIMITS. "
        ...
        ("2.", "The Stowers duty shifts the risk of an excess judgment (i.e., a judgment for "
         "more than the policy limits) from the insured to the insurer (i.e., GEICO Insurance)."),
        ("3.", "An insured suffers an injury for Stowers’ purposes if an excess judgment "
         "is awarded in this litigation."),
        ("4.", "If GEICO Insurance fails to settle with the Plaintiff "
         "(i.e., if GEICO Insurance fails to accept the demand stated "
         "in this letter), and if an excess judgment is awarded, Plaintiff may be entitled "
         "to recovery of actual damages, exemplary damages, interest, court costs, and "
         "attorney fees against GEICO Insurance."),
        ...
        ("6.", "Again, the insured, Eusebia Abdelrahim, is being given a chance to protect her "
         "financial assets. If insured should demand that GEICO Insurance settle for our "
         "offer, and GEICO Insurance refuses to do so, then the insured, Eusebia Abdelrahim, "
         "will be able to shift the risk of any excess judgment to the insurance company. "
         "Thus, by the insured Eusebia Abdelrahim demanding her insurance company immediately "
         "settle for the offer made herein, the insured, Eusebia Abdelrahim, can ensure that "
         "the insurance company will be responsible for paying any excess judgment. By making "
         "this offer, our client has given the insured, Eusebia Abdelrahim, an opportunity to "
         "protect her individual assets. To protect these assets, she need only demand that "
         "the insurance company settle for our policy limits offer stated herein. Thereafter, "
         "any failure on the part of GEICO Insurance to do so would clearly be unreasonable "
    ...
    story.append(Paragraph(
        ...
        "Again, I trust that the insured, Eusebia Abdelrahim, will be explained the dangers "
        "of this case and the role she can play in protecting her personal assets from excess "
        "judgment. Certainly, insured would probably be best served by GEICO Insurance "
        "forwarding this letter directly to her for review with a recommendation that she "
        "seek the advice of an attorney of her own choosing. In exchange for the payment of "
        "the policy limits held by insured, Eusebia Abdelrahim, Plaintiff will agree to "
        "provide an executed full and final release of all claims against the insured, "
        "Eusebia Abdelrahim, arising out of the incident which is the basis of this claim.",
        NORMAL))
